            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input 
                        ...
                        id="time_start" 
                        name="time_start" 
                        value="{{ old('time_start', date('H:i', strtotime($event->time_start))) }}"
                        class="form-input"
                        required
                    >
                    @error('time_start')
                ...
                <div>
                    ...
                    <input 
                        ...
                        id="time_end" 
                        name="time_end" 
                        value="{{ old('time_end', date('H:i', strtotime($event->time_end))) }}"
                        class="form-input"
                        required
                    >
                    @error('time_end')
                ...
                @if($event->image)
                    <div class="md:col-span-2">
                        ...
                        <img src="{{ asset('storage/' . $event->image) }}" alt="{{ $event->name }}" class="max-h-48 rounded-lg">
                    </div>
                @endif
