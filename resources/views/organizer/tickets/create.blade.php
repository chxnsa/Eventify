<x-organizer-layout>
    ...
    <h1 class="text-2xl font-bold text-gray-900 mb-2">Add Ticket</h1>
    <p class="text-gray-600 mb-8">Create a new ticket type for {{ $event->name }}</p>

    <div class="bg-white rounded-xl shadow-sm p-6">
        <form action="{{ route('organizer.tickets.store', $event) }}" method="POST" enctype="multipart/form-data">
            @csrf
